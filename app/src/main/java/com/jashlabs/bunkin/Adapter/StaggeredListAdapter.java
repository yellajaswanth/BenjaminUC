...
public class StaggeredListAdapter extends ArrayAdapter<String> {
    ...
    private static final String TAG = "StaggeredListAdapter";
    ...
    public StaggeredListAdapter(final Context context, final int textViewResourceId) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_staggered_view, parent, false);
            vh = new ViewHolder();
